...
-- ────────────────────────────────────────────────────────────
-- 12. ACCOUNTS (7 conti bancari per Riccardo)
-- ────────────────────────────────────────────────────────────

INSERT INTO accounts (id, user_id, name, bank, entity, account_type, balance, color, sort_order) VALUES
  ('b0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'BNL CC', 'BNL', 'piva', 'checking', 0, '#009639', 0),
  ('b0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'BNL Carta', 'BNL', 'piva', 'credit_card', 0, '#009639', 1),
  ('b0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'Sella CC', 'Sella', 'spa', 'checking', 0, '#0066CC', 2),
  ('b0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'Sella Carta 9664', 'Sella', 'spa', 'credit_card', -8440.97, '#0066CC', 3),
  ('b0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', 'Fideuram CC', 'Fideuram', 'spa', 'checking', 0, '#1B3C73', 4),
  ('b0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', 'Unicredit CC', 'Unicredit', 'spa', 'checking', 0, '#E30613', 5),
  ('b0000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000001', 'AMEX Platinum', 'AMEX', 'spa', 'credit_card', 0, '#006FCF', 6);

-- ────────────────────────────────────────────────────────────
-- 13. EXPENSE CATEGORIES
-- ────────────────────────────────────────────────────────────

INSERT INTO expense_categories (id, user_id, name, color, icon, sort_order) VALUES
  ('k0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Ristoranti', '#FF6B6B', '🍽️', 0),
  ('k0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'Shopping', '#4ECDC4', '🛍️', 1),
  ('k0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'Abbonamenti', '#45B7D1', '📱', 2),
  ('k0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'Energia', '#FFA07A', '⚡', 3),
  ('k0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', 'Online/Tech', '#98D8C8', '💻', 4),
  ('k0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', 'Parcheggio', '#C9B1FF', '🅿️', 5),
  ('k0000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000001', 'Tabaccherie', '#FFD93D', '🚬', 6),
  ('k0000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000001', 'Bar/Caffè', '#6BCB77', '☕', 7),
  ('k0000000-0000-0000-0000-000000000009', 'a0000000-0000-0000-0000-000000000001', 'Altro', '#95AFC0', '📦', 8);

-- ────────────────────────────────────────────────────────────
-- 14. MONTHLY SUMMARIES (last 4 months)
-- ────────────────────────────────────────────────────────────

INSERT INTO monthly_summary (id, user_id, month, year, month_number, income, expenses, fee_earned, entity) VALUES
  ('m0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Nov 25', 2025, 11, 0, 1733.61, 0, 'piva'),
  ('m0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'Dic 25', 2025, 12, 0, 2092.40, 0, 'piva'),
  ('m0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'Gen 26', 2026, 1, 0, 2390.58, 0, 'piva'),
  ('m0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'Feb 26', 2026, 2, 0, 2224.38, 0, 'piva');

-- ────────────────────────────────────────────────────────────
-- 15. TRANSACTIONS (sample expenses across 4 months)
-- ────────────────────────────────────────────────────────────

INSERT INTO transactions (id, user_id, account_id, amount, type, category, description, date) VALUES
  -- Nov 2025
  ('x0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -420.00, 'expense', 'Ristoranti', 'Cene lavoro novembre', '2025-11-15'),
  ('x0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -280.00, 'expense', 'Shopping', 'Acquisti vari', '2025-11-20'),
  ('x0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -189.99, 'expense', 'Abbonamenti', 'Abbonamenti mensili', '2025-11-01'),
  ('x0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -245.00, 'expense', 'Energia', 'Bollette novembre', '2025-11-10'),
  ('x0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -156.50, 'expense', 'Online/Tech', 'Software e servizi', '2025-11-12'),
  ('x0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -72.12, 'expense', 'Parcheggio', 'Parcheggi novembre', '2025-11-25'),
  ('x0000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -95.00, 'expense', 'Bar/Caffè', 'Bar e caffè', '2025-11-28'),
  ('x0000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -275.00, 'expense', 'Altro', 'Varie novembre', '2025-11-30'),
  -- Dic 2025
  ('x0000000-0000-0000-0000-000000000009', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -580.00, 'expense', 'Ristoranti', 'Cene natalizie', '2025-12-20'),
  ('x0000000-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -520.00, 'expense', 'Shopping', 'Regali di Natale', '2025-12-18'),
  ('x0000000-0000-0000-0000-000000000011', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -189.99, 'expense', 'Abbonamenti', 'Abbonamenti mensili', '2025-12-01'),
  ('x0000000-0000-0000-0000-000000000012', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -310.00, 'expense', 'Energia', 'Bollette dicembre', '2025-12-10'),
  ('x0000000-0000-0000-0000-000000000013', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -120.00, 'expense', 'Tabaccherie', 'Tabacchi dicembre', '2025-12-15'),
  ('x0000000-0000-0000-0000-000000000014', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -372.41, 'expense', 'Altro', 'Varie dicembre', '2025-12-28'),
  -- Gen 2026
  ('x0000000-0000-0000-0000-000000000015', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -490.00, 'expense', 'Ristoranti', 'Cene lavoro gennaio', '2026-01-15'),
  ('x0000000-0000-0000-0000-000000000016', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -350.00, 'expense', 'Shopping', 'Acquisti saldi', '2026-01-10'),
  ('x0000000-0000-0000-0000-000000000017', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -189.99, 'expense', 'Abbonamenti', 'Abbonamenti mensili', '2026-01-01'),
  ('x0000000-0000-0000-0000-000000000018', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -410.00, 'expense', 'Energia', 'Bollette gennaio', '2026-01-10'),
  ('x0000000-0000-0000-0000-000000000019', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -220.00, 'expense', 'Online/Tech', 'Hardware e software', '2026-01-20'),
  ('x0000000-0000-0000-0000-000000000020', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -88.50, 'expense', 'Parcheggio', 'Parcheggi gennaio', '2026-01-25'),
  ('x0000000-0000-0000-0000-000000000021', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -135.00, 'expense', 'Tabaccherie', 'Tabacchi gennaio', '2026-01-22'),
  ('x0000000-0000-0000-0000-000000000022', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -507.09, 'expense', 'Altro', 'Varie gennaio', '2026-01-30'),
  -- Feb 2026
  ('x0000000-0000-0000-0000-000000000023', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -445.00, 'expense', 'Ristoranti', 'Cene lavoro febbraio', '2026-02-12'),
  ('x0000000-0000-0000-0000-000000000024', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -380.00, 'expense', 'Shopping', 'Acquisti vari', '2026-02-15'),
  ('x0000000-0000-0000-0000-000000000025', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -189.99, 'expense', 'Abbonamenti', 'Abbonamenti mensili', '2026-02-01'),
  ('x0000000-0000-0000-0000-000000000026', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -380.00, 'expense', 'Energia', 'Bollette febbraio', '2026-02-10'),
  ('x0000000-0000-0000-0000-000000000027', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', -178.00, 'expense', 'Online/Tech', 'Software cloud', '2026-02-08'),
  ('x0000000-0000-0000-0000-000000000028', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -65.00, 'expense', 'Parcheggio', 'Parcheggi febbraio', '2026-02-20'),
  ('x0000000-0000-0000-0000-000000000029', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -110.00, 'expense', 'Bar/Caffè', 'Bar e caffè', '2026-02-22'),
  ('x0000000-0000-0000-0000-000000000030', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', -476.39, 'expense', 'Altro', 'Varie febbraio', '2026-02-28');
